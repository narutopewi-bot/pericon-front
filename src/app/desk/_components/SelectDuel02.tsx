  ...
  return (
    ...
    >
      <div className="flex items-center">
        <span className="ml-[17px] block font-normal truncate">{option.name}</span>
      </div>
    </li>
  );
};

const SelectDuel02: React.FC<SelectProps> = ({
  name = "customSelect",
  value = "-- Select Option --",
  options = [],
  updateValue,
